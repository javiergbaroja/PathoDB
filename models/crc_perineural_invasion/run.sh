#!/bin/bash
# =============================================================================
# CRC Perineural Invasion — SLURM inference script
...
#SBATCH --job-name=crc_pni
#SBATCH --qos=job_gpu_preemptable
#SBATCH --output=/storage/research/igmp_dp_workspace/garciabaroja_javier/PW_reports/database/pathodb/logs/crc_perineural_invasion_%j.out
#SBATCH --error=/storage/research/igmp_dp_workspace/garciabaroja_javier/PW_reports/database/pathodb/logs/crc_perineural_invasion_%j.err
...
echo "=== PathoDB CRC Perineural Invasion ==="
echo "Started     : $(date)"
echo "Node        : $(hostname)"
...
INFERENCE_SCRIPT="${PROJECT_DIR}/models/crc_perineural_invasion/infer.py"

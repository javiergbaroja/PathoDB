#!/bin/bash
# =============================================================================
# CRC Tumour Budding — SLURM inference script
...
#SBATCH --job-name=crc_budding
#SBATCH --qos=job_gpu_preemptable
#SBATCH --output=/storage/research/igmp_dp_workspace/garciabaroja_javier/PW_reports/database/pathodb/logs/crc_tumour_budding_%j.out
#SBATCH --error=/storage/research/igmp_dp_workspace/garciabaroja_javier/PW_reports/database/pathodb/logs/crc_tumour_budding_%j.err
...
echo "=== PathoDB CRC Tumour Budding ==="
echo "Started     : $(date)"
echo "Node        : $(hostname)"
...
INFERENCE_SCRIPT="${PROJECT_DIR}/models/crc_tumour_budding/infer.py"
